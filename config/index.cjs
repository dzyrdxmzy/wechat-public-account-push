  ...
  USERS: [
    {
      ...
      id: 'oWR05vjsIUvEb3mvYCNRdexBV3CI',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'IbIef9_VmwJ-2yJ33afe8GWEI5nv8wBm7YC-kgxcYWg',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老大', year: '2000', date: '05-09',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2025-11-26' },
        // 结婚纪念日
